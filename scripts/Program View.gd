...
var INSTRUCTIONS = {
					...
					"adi": [[2],
							[Callable(self, "Register"), func (value: String, line: int, instruction: String): return Immediate(value, 8, line, instruction)]],
					"jmp": [[1],
							[func (value: String, line: int, instruction: String): return Immediate(value, 6, line, instruction)]],
					"cal": [[1],
							[func (value: String, line: int, instruction: String): return Immediate(value, 6, line, instruction)]],
					"ret": [[0],
							[]],
					"brh": [[2],
							[Callable(self, "Condition"), func (value: String, line: int, instruction: String): return Immediate(value, 6, line, instruction)]],
					"pst": [[2],
							[func (value: String, line: int, instruction: String): return Immediate(value, 3, line, instruction),Callable(self, "Register")]],
					"pld": [[2],
							[func (value: String, line: int, instruction: String): return Immediate(value, 3, line, instruction),Callable(self, "Register")]]}
...
func _on_text_changed() -> void:
	...
	for line in get_line_count():
		...
		if split_str[0] in INSTRUCTIONS:
			...
			if valid_line > 63:
				set_line_background_color(line, Color.hex(0xC5696966))
				show_error("Error: program is larger than 63 instructions, please shorten the program")
